...
def create_csv():
    ...
    with open("results.csv", "w") as f:
        f.write("ID, Correctness, Validity, Time Complexity Generated, Time Complexity Canonical, Space Complexity Generated, Space Complexity Canonical, Security, Maintainability, Reliability\n")
        for i in range(TEST_COUNT):
            f.write(str(i) + ", -1, -1, -1, -1, -1, -1, -1, -1, -1\n")
